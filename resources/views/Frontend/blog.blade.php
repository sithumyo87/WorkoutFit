            ...
            <div class="row">
                <div class="col-lg-8 p-0">
                    <div class="blog-item">
                        ...
                        <div class="bi-text">
                            <h5><a href="<?= url('/blog_detail'); ?>">Vegan White Peach Mug Cobbler With Cardam Vegan White Peach Mug
                                    Cobbler...</a></h5>
                            <ul>
                                <li>by Admin</li>
                                <li>Aug,15, 2019</li>
                    ...
                    <div class="sidebar-option">
                        ...
                        <div class="so-latest">
                            ...
                            <div class="latest-large set-bg" data-setbg="img/letest-blog/latest-1.jpg">
                                <div class="ll-text">
                                    <h5><a href="<?= url('/blog_detail'); ?>">This Japanese Way of Making Iced Coffee Is a Game...</a></h5>
                                    <ul>
                                        <li>Aug 20, 2019</li>
                                        <li>20 Comment</li>
                                    </ul>
                            ...
                            <div class="latest-item">
                                ...
                                <div class="li-text">
                                    <h6><a href="<?= url('/blog_detail'); ?>">Grilled Potato and Green Bean Salad</a></h6>
