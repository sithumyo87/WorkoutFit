            ...
            <div class="row">
                <div class="col-lg-8 p-0">
                    <div class="blog-item">
                        ...
                        <div class="bi-text">
                            <h5><a href="<?= url('/diet_detail'); ?>">Canned Fruit</a></h5>
                            <ul>
                                <li>by Admin</li>
                                <li>Aug,15, 2019</li>
                                <!-- <li>20 Comment</li> -->
                            </ul>
                            <p>Canned fruits have the same calories as fresh ones, but be on the lookout for added syrup.</p>
                        </div>
                    </div>
                    <div class="blog-item">
                        <div class="bi-pic">
